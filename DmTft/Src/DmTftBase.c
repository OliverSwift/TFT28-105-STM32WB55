...
extern void setPixel(uint16_t x, uint16_t y, uint16_t color);
extern void setAddress(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1);
extern void sendData(uint16_t data);
extern void sendRepeatedData(uint32_t num, uint16_t data);
extern void sendCommand(uint8_t index);
extern void select();
...
void clearScreen(uint16_t color) {
  ...
  sendRepeatedData(_height*_width, color);
...
void drawHorizontalLine(uint16_t x, uint16_t y, uint16_t length, uint16_t color) {
  ...
  sendRepeatedData(length+1, color);
...
void fillRectangle(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color) {
  ...
  sendRepeatedData(numPixels, color);
