...
static void DmTftIli9341_init(uint16_t width, uint16_t height) {
	...
	const uint8_t inits[] = {
			// CMD, Num, parameters
			0xCF,   3,   0x00, 0xc3, 0x30,
			0xED,   4,   0x64, 0x03, 0x12, 0x81,
			0xE8,   3,   0x85, 0x10, 0x79,
			...
			0xF2,   1,   0x00,
			0x26,   1,   0x01,
			0xE0,  15,   0x0F, 0x3F, 0x2F, 0x0C, 0x10, 0x0A, 0x53, 0XD5, 0x40, 0x0A, 0x13, 0x03, 0x08, 0x03, 0x00,
			0xE1,  15,   0x00, 0x00, 0x10, 0x03, 0x0F, 0x05, 0x2C, 0xA2, 0x3F, 0x05, 0x0E, 0x0C, 0x37, 0x3C, 0x0F,
			0x00 // END
	};
