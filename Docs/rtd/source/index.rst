...
The project is to use nifty `DisplayModule TFT28-105 <https://www.displaymodule.com/products/dm-tft28-105>`_ on Nucleo board and more specifically on a STM32WB55 one.
